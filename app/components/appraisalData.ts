...
export type HrApprovalMethod = "Accepted Superior Recommendation" | "Overridden Recommendation";
...
export interface PeriodAppraisal {
  ...
  hrApprovalMethod?: HrApprovalMethod | null;
...
export function readLive(empId: string): Partial<PeriodAppraisal> {
  const storedStatus = localStorage.getItem(K(empId, "status"));
  const status: AppStatus | null = storedStatus === "Ready for Appraisal" || storedStatus === "Draft" ? "Draft"
    : storedStatus === "Pending Review" ? "Pending Review"
    : storedStatus === "Return for Revision" || storedStatus === "Returned" ? "Returned"
    : storedStatus === "Approve" || storedStatus === "Override and Approve" || storedStatus === "Approved" ? "Approved"
    : null;
  ...
  const hrMethod = localStorage.getItem(K(empId, "hrApprovalMethod")) as HrApprovalMethod | null;
  ...
  if (storedStatus === "Ready for Appraisal") out.readyForAppraisal = true;
  if (dec)            out.managerDecision = dec;
  if (just !== null)  out.justification   = just;
  if (hrDec)          out.hrDecision      = hrDec;
  if (hrMethod)       out.hrApprovalMethod = hrMethod;
  else if (storedStatus === "Override and Approve") out.hrApprovalMethod = "Overridden Recommendation";
  else if (storedStatus === "Approve") out.hrApprovalMethod = "Accepted Superior Recommendation";
...
export function writeLive(empId: string, patch: Partial<PeriodAppraisal>) {
  ...
  if (patch.hrApprovalMethod !== undefined)
    localStorage.setItem(K(empId, "hrApprovalMethod"), patch.hrApprovalMethod ?? "");
...
export const EMPLOYEES: Record<string, EmployeeAppraisalData> = {
  amir: {
    ...
    periods: {
      "2027 Annual KPI Review": {
        status: "Draft", readyForAppraisal: true, kpiScore: 78.4, attScore: 82.0, finalScore: 80.2,
        managerDecision: null, justification: "",
        hrDecision: null, hrOverrideReason: "", hrReturnReason: "",
        submittedDate: "", finalDate: "",
      },
      "2026 Annual KPI Review": {
        status: "Approved", hrApprovalMethod: "Overridden Recommendation", kpiScore: 77.1, attScore: 81.0, finalScore: 79.1,
      ...
      "2025 Annual KPI Review": {
        status: "Approved", hrApprovalMethod: "Accepted Superior Recommendation", kpiScore: 76.3, attScore: 80.2, finalScore: 78.3,
      ...
      "2024 Annual KPI Review": {
        status: "Approved", hrApprovalMethod: "Accepted Superior Recommendation", kpiScore: 74.8, attScore: 78.5, finalScore: 76.7,
  ...
  sarah: {
    ...
    periods: {
      ...
      "2026 Annual KPI Review": {
        status: "Approved", hrApprovalMethod: "Accepted Superior Recommendation", kpiScore: 72.8, attScore: 78.0, finalScore: 75.4,
        managerDecision: "Salary Increment",
      ...
      "2025 Annual KPI Review": {
        status: "Approved", hrApprovalMethod: "Accepted Superior Recommendation", kpiScore: 71.5, attScore: 76.3, finalScore: 73.9,
        managerDecision: "No Recommendation",
  ...
  rizal: {
    ...
    periods: {
      ...
      "2026 Annual KPI Review": {
        status: "Approved", hrApprovalMethod: "Accepted Superior Recommendation", kpiScore: 70.5, attScore: 75.0, finalScore: 72.8,
        managerDecision: "No Recommendation",
      ...
      "2025 Annual KPI Review": {
        status: "Approved", hrApprovalMethod: "Accepted Superior Recommendation", kpiScore: 69.2, attScore: 73.8, finalScore: 71.5,
        managerDecision: "No Recommendation",
  ...
  nurul: {
    ...
    periods: {
      "2027 Annual KPI Review": {
        status: "Approved", hrApprovalMethod: "Accepted Superior Recommendation", kpiScore: 83.2, attScore: 85.1, finalScore: 84.2,
        managerDecision: "Promotion",
      ...
      "2026 Annual KPI Review": {
        status: "Approved", hrApprovalMethod: "Overridden Recommendation", kpiScore: 82.0, attScore: 84.1, finalScore: 83.1,
      ...
      "2025 Annual KPI Review": {
        status: "Approved", hrApprovalMethod: "Accepted Superior Recommendation", kpiScore: 80.8, attScore: 83.2, finalScore: 82.0,
        managerDecision: "Salary Increment",
      ...
      "2024 Annual KPI Review": {
        status: "Approved", hrApprovalMethod: "Accepted Superior Recommendation", kpiScore: 79.5, attScore: 82.0, finalScore: 80.8,
        managerDecision: "Salary Increment",
